...
class ThemeColors {
  ...
  static final lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(surface: lightBackgroundColor),
    scaffoldBackgroundColor: lightBackgroundColor,
    visualDensity: VisualDensity.adaptivePlatformDensity,
    buttonTheme: ButtonThemeData(buttonColor: lightTextColor),
  ...
  static final darkTheme = ThemeData(
    ...
    fontFamily: 'Poppins',
    primaryColor: primaryColor,
    colorScheme: ColorScheme.dark(surface: darkBackgroundColor),
    scaffoldBackgroundColor: const Color(0xFF00040F),
    visualDensity: VisualDensity.adaptivePlatformDensity,
    buttonTheme: ButtonThemeData(buttonColor: darkTextColor),
    appBarTheme: AppBarTheme(
